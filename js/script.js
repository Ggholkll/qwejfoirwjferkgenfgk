...
window.addEventListener('scroll' , functionResize)
 ...
 function functionResize(e) {
  ...
  if (Width <= 1280) {
     ...
     functionehead( elementItemMenu.after(elementLogo)  , headerContent.append(elementContact), elementForm.insertBefore(elementSearch , elementInsertBeforeForm)  , elementContact.classList.add('top-header__columns') )   
      : 
